...
export default function Footer() {
  return (
    <footer
      ...
      style={{ paddingLeft: '14px', paddingRight: '14px', paddingTop: '40px', paddingBottom: '30px' }}>
      <div className="max-w-350 mx-auto px-6 md:px-12 py-16">
        <div
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted">
              <li>
                <a href="mailto:funpeople.hq@gmail.com" className="hover:text-foreground transition-colors">
        ...
        <motion.div
          ...
          <p className="text-sm text-muted">&copy; {new Date().getFullYear()} Jaemisseo. All rights reserved.</p>
          <p className="text-sm text-muted">Made with fun in Korea</p>
        </motion.div>
      </div>
    </footer>
  );
