...
const services = [
  {
    number: "01",
    title: "Mobile App",
    description: "iOS와 Android를 위한 네이티브 및 크로스 플랫폼 앱 개발. React Native, Flutter 등 최신 기술로 구현합니다.",
    icon: (
  ...
  },
  {
    ...
    description: "모던 기술 스택으로 만드는 빠르고 아름다운 웹사이트. Next.js, React로 최적의 사용자 경험을 제공합니다.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    number: "04",
    title: "UI/UX Design",
    description: "사용자 중심의 직관적이고 아름다운 인터페이스 설계. 데이터 기반의 UX 리서치로 최적의 경험을 설계합니다.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
