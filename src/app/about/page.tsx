...
export default function AboutPage() {
  ...
  return (
    <PageTransition>
      {/* Hero Section */}
      <section
        className="min-h-screen pt-32 pb-20 px-6 bg-background flex items-center"
        style={{ paddingLeft: '10px', paddingRight: '10px' }}>
        <div className="max-w-7xl mx-auto" style={{ paddingLeft: '15px', paddingRight: '15px' }}>
          <FadeIn>
            <span className="text-primary text-sm font-medium uppercase tracking-wider" style={{ marginBottom: '6px' }}>
              About Us
            </span>
          ...
          <FadeIn delay={0.2}>
            <p className="text-xl md:text-2xl text-muted max-w-3xl leading-relaxed">
              Jaemisseo(재밌어)는 &ldquo;재밌다&rdquo;는 우리말에서 따온 이름입니다. 우리는 개발이 재밌고, 만드는 것이
              재밌고, 문제를 해결하는 것이 재밌습니다.
              <br />
              <br />그 재미를 고객과 함께 나누고 싶습니다.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      {/* Marquee Section */}
      <div className="py-8 border-y border-white/10 overflow-hidden" style={{ marginBottom: '14px' }}>
        <Marquee speed="slow">
      ...
      <section className="py-32 px-6 bg-background">
        <div className="max-w-7xl mx-auto" style={{ paddingRight: '10px', paddingLeft: '10px' }}>
          <FadeIn className="mb-16 text-center">
            <span className="text-primary text-sm font-medium uppercase tracking-wider">Our Values</span>
            <h2 className="text-4xl md:text-5xl font-bold mt-4" style={{ marginBottom: '14px' }}>
              우리의 가치
            </h2>
          </FadeIn>
          ...
          <div
            ...
            {values.map((value, index) => (
              <motion.div
                ...
                className="group p-8 bg-white/2 border border-white/10 rounded-2xl hover:border-primary/50 transition-all duration-500">
                <div
                ...
                <h3 className="text-xl font-bold mb-3 text-foreground" style={{ marginBottom: '6px' }}>
                  {value.title}
                </h3>
      ...
      <section
        ...
        <div className="parallax-text absolute inset-0 flex items-center justify-center pointer-events-none select-none">
          <span className="text-[20vw] font-bold text-white/2 whitespace-nowrap">JAEMISSEO</span>
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <FadeIn>
            <motion.div
              ...
              <span className="text-6xl md:text-8xl font-bold text-gradient">Jaemisseo</span>
            </motion.div>
            <p className="mt-8 text-xl md:text-2xl text-muted leading-relaxed">재밌게 이것저것 만드는 회사</p>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <FadeIn>
            <h2
              ...
              <span className="text-foreground">우리는</span> <span className="text-gradient">이렇게</span>{' '}
