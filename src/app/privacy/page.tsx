...
export default function PrivacyPage() {
  return (
    <PageTransition>
      <section
        style={{ paddingTop: '160px', paddingBottom: '160px', paddingLeft: '25px', paddingRight: '25px' }}
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <div className="space-y-12">
              <section
                ...
                <h2 className="text-2xl font-bold mb-4 text-foreground">1. 개인정보의 처리 목적</h2>
                <p className="text-muted leading-relaxed">
                  Jaemisseo(이하 &quot;회사&quot;)는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는
              ...
              <section
                ...
                <h2 className="text-2xl font-bold mb-4 text-foreground">2. 수집하는 개인정보 항목</h2>
                <p className="text-muted leading-relaxed">
              ...
              <section
                ...
                <h2 className="text-2xl font-bold mb-4 text-foreground">3. 개인정보의 보유 및 이용 기간</h2>
                <p className="text-muted leading-relaxed">
              ...
              <section
                ...
                <h2 className="text-2xl font-bold mb-4 text-foreground">4. 개인정보의 제3자 제공</h2>
                <p className="text-muted leading-relaxed">
                  회사는 원칙적으로 정보주체의 개인정보를 제1조에서 명시한 목적 범위 내에서 처리하며, 정보주체의 사전
                  동의 없이는 본래의 목적 범위를 초과하여 처리하거나 제3자에게 제공하지 않습니다.
                </p>
              </section>
              ...
              <section
                ...
                <h2 className="text-2xl font-bold mb-4 text-foreground">5. 개인정보처리의 위탁</h2>
                <p className="text-muted leading-relaxed">
              ...
              <section
                ...
                <h2 className="text-2xl font-bold mb-4 text-foreground">6. 정보주체의 권리·의무 및 행사방법</h2>
                <p className="text-muted leading-relaxed">
              ...
              <section
                ...
                <h2 className="text-2xl font-bold mb-4 text-foreground">7. 개인정보의 파기</h2>
                <p className="text-muted leading-relaxed">
              ...
              <section
                ...
                <h2 className="text-2xl font-bold mb-4 text-foreground">8. 개인정보 보호책임자</h2>
                <p className="text-muted leading-relaxed">
                  회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및
                  피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
                </p>
                <div
                  className="mt-4 p-4 bg-white/2 border border-white/10 rounded-lg"
                  style={{
                    padding: '8px',
                  }}>
              ...
              <section
                ...
                <h2 className="text-2xl font-bold mb-4 text-foreground">9. 개인정보처리방침의 변경</h2>
                <p className="text-muted leading-relaxed">
              ...
              <section
                ...
                <h2 className="text-2xl font-bold mb-4 text-foreground">10. 권익침해 구제방법</h2>
                <p className="text-muted leading-relaxed">
